...
static void test_pal_m_uses_pal_phase_alternation(void)
{
    uint8_t pixels[4] = {0xFC, 0xFC, 0xFC, 0xFC};
    uint16_t even_samples[CRT_COMPOSITE_RGB332_SAMPLES_PER_4] = {0};
    uint16_t odd_samples[CRT_COMPOSITE_RGB332_SAMPLES_PER_4] = {0};

    assert(crt_composite_rgb332_packed(CRT_VIDEO_STANDARD_PAL_M, 0, 0xFC) == 0x47514035U);
    assert(crt_composite_rgb332_packed(CRT_VIDEO_STANDARD_PAL_M, 1, 0xFC) == 0x40514735U);
    crt_composite_rgb332_encode_quad(CRT_VIDEO_STANDARD_PAL_M, 0, pixels, even_samples);
    crt_composite_rgb332_encode_quad(CRT_VIDEO_STANDARD_PAL_M, 1, pixels, odd_samples);
